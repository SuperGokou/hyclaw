...
// HYClaw 瘦身:移除 workboard/cron/tasks/plugins 等开发者/分布式入口,
// 只保留办公场景需要的侧边栏项;skills 提升为独立侧边栏项。
export const SIDEBAR_NAV_ROUTES = [
  "skills",
  "usage",
] as const satisfies readonly NavigationRouteId[];

// HYClaw 瘦身:插件 Hub 已移除,skills 作为独立侧边栏项直达,不再归属 Hub。
...
export const SETTINGS_NAVIGATION_GROUPS = [
  ...
  },
  {
    ...
    routes: ["infrastructure", "logs", "about"],
  },
