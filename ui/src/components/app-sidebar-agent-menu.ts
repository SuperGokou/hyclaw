...
const HYCLAW_REPO = "https://github.com/SuperGokou/hyclaw";
const AGENT_MENU_LINKS: ReadonlyArray<{ href: string; icon: IconName; label: () => string }> = [
  { href: `${HYCLAW_REPO}/blob/main/README.md`, icon: "book", label: () => t("common.docs") },
  { href: `${HYCLAW_REPO}/issues`, icon: "messageSquare", label: () => t("agentChip.getHelp") },
  {
    href: `${HYCLAW_REPO}/releases`,
    icon: "scrollText",
