...
export const icons = {
  ...
  `,
  // HYClaw mascot glyph — a four-star dragon ball (on-theme with the Goku
  // mascot, crisp at small sizes). Icon id kept as "lobster" for internal
  // compatibility; the artwork is EFD's.
  lobster: html`
    <svg viewBox="0 0 120 120" fill="none">
      <defs>
        <radialGradient id="hy-ball-g" cx="40%" cy="35%" r="70%">
          <stop offset="0%" stop-color="#ffe08a" />
          <stop offset="55%" stop-color="#ff9d2e" />
          <stop offset="100%" stop-color="#e8781a" />
        </radialGradient>
      </defs>
      <circle cx="60" cy="60" r="46" fill="url(#hy-ball-g)" />
      <ellipse cx="45" cy="42" rx="14" ry="9" fill="#ffffff" opacity="0.35" />
      <g fill="#d61f26">
        <path
          d="M60 40l3.4 6.9 7.6 1.1-5.5 5.4 1.3 7.6L60 64.6l-6.8 3.6 1.3-7.6-5.5-5.4 7.6-1.1z"
        />
        <path d="M45 62l2.3 4.6 5 .7-3.6 3.6.9 5-4.6-2.4-4.6 2.4.9-5-3.6-3.6 5-.7z" />
        <path d="M75 62l2.3 4.6 5 .7-3.6 3.6.9 5-4.6-2.4-4.6 2.4.9-5-3.6-3.6 5-.7z" />
        <path d="M60 74l2.3 4.6 5 .7-3.6 3.6.9 5-4.6-2.4-4.6 2.4.9-5-3.6-3.6 5-.7z" />
      </g>
    </svg>
  `,
  refresh: html`
