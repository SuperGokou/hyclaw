...
const PALETTES: Array<[LobsterPetPalette, number]> = [
  // HYClaw recolors the dominant palettes to the Goku-orange brand family so the
  // residual sidebar/brand creature stays on-theme with the mascot.
  [{ id: "crimson", shell: "#ff7a1a", claw: "#ffab52" }, 26],
  [{ id: "coral", shell: "#ff9d2e", claw: "#ffc06b" }, 26],
