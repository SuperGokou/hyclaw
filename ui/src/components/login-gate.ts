...
function buildFeedback(params: {
  ...
  const docsHref = params.docsHref ?? "https://github.com/SuperGokou/hyclaw";
  return {
    kind: params.kind,
...
function resolveLoginFailureFeedback(
  ...
  if (pairing) {
    return buildFeedback({
      ...
      rawError,
      docsHref: "https://github.com/SuperGokou/hyclaw",
      titleKey:
    ...
    <div class="login-gate">
      <div class="login-gate__card">
        <div class="login-gate__header">
          <img class="login-gate__logo" src=${faviconSrc} alt="HYClaw" />
          <div class="login-gate__title">HYClaw</div>
