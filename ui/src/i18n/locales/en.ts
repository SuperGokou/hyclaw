...
export const en: TranslationMap = {
  ...
  lazyView: {
    ...
    staleSubtitle: "HYClaw was updated in the background. Reload to get the latest panel.",
    retry: "Retry",
  },
  nodes: {
    pairing: {
      ...
      qrAlt: "HYClaw mobile pairing QR code",
      ...
      review: "Review",
      waiting: "Official HYClaw mobile apps connect automatically after scanning.",
      help: "Pairing help",
  ...
  worktrees: {
    ...
    subtitle: "Isolated repository checkouts owned by HYClaw.",
    cleanNow: "Clean up now",
    cleanupTitle: "Cleanup",
    cleanupSubtitle:
      "HYClaw periodically removes old worktrees to free disk space. Tune how aggressively cleanup runs.",
  ...
  configView: {
    ...
    retry: "Retry",
    applyBannerText: "Saved to hyclaw.json — restart the gateway to apply.",
  ...
  approvalPage: {
    ...
    connectionErrorDescription:
      "HYClaw cannot confirm or record a decision while disconnected. Reconnect to check the current status.",
    retry: "Retry",
  ...
  modelSetup: {
    ...
    intro:
      "HYClaw reuses AI access you already have — a CLI login, an API key, or a provider sign-in.",
    ...
    access: {
      ...
      gatewayTooOld: "The Gateway is running an older HYClaw version",
    },
    candidates: {
  ...
  memoryImport: {
    ...
    confirmBackup: "HYClaw creates a verified pre-import backup before copying memory.",
    confirmImport: "Import memory",
    disconnected: "Connect to the gateway to import memory.",
    title: "Import assistant memory",
    subtitle:
      "Review Codex consolidated memory and Claude Code auto-memory before copying it into HYClaw.",
  ...
  onboarding: {
    memoryImport: {
      ...
      body: "HYClaw found memory from other coding assistants. Import it into your agent workspace?",
      ...
      doneBody: "Migrated {migrated}, skipped {skipped}. You can continue setting up HYClaw.",
    },
  },
  mcpPage: {
  ...
  pluginsPage: {
    ...
    noInstalledBody: "Discover a featured plugin or search ClawHub to extend HYClaw.",
    ...
    optionalCapability: "Optional HYClaw capability.",
    enabled: "Enabled",
    disabled: "Disabled",
    available: "Available",
  ...
  aboutPage: {
    ...
    license: "© 2026 HYClaw Foundation — MIT License.",
  ...
  profilePage: {
    avatarUpload: "Click to set a custom avatar",
    avatarInvalid: "Please choose an image under 1 MB.",
    avatarNeedsConnection: "Connect to the gateway before changing the avatar.",
  ...
  skillWorkshop: {
    ...
    selfLearning: {
      ...
      pitchBody:
        "HYClaw reviews corrections and substantial completed runs, then drafts skill proposals for this board. It spends extra background tokens and drafts arrive as pending proposals.",
  ...
  workspaces: {
    ...
    empty: {
      ...
      onboardingCommand: "HYClaw workspaces tabs create --title Main",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Paste the token from HYClaw dashboard --no-open or enter the configured password.",
        stepGenerate:
          "If no token is configured, run HYClaw doctor --generate-gateway-token on the gateway host.",
      ...
      authFailed: {
        ...
        stepDashboard: "Run HYClaw dashboard --no-open and open the fresh URL or paste its token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Run HYClaw devices list on the Gateway host.",
        stepApproveId: "Approve this request: HYClaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Reopen the served dashboard with HYClaw dashboard so the UI and Gateway come from the same install.",
        stepDevUi:
          "If using pnpm ui:dev, rebuild or restart the dev UI against the current checkout.",
        stepRestart: "Restart the Gateway after updating HYClaw so it serves the current protocol.",
      },
      network: {
        title: "Could not connect",
        summary:
          "The browser could not complete the Gateway connection. Check the target and transport before retrying credentials.",
        stepGateway: "Confirm the Gateway is running with HYClaw status or HYClaw gateway run.",
        stepUrl:
          "Check the WebSocket URL and use wss:// when the Gateway is behind HTTPS/Tailscale Serve.",
        stepDashboard:
          "Reopen the dashboard with HYClaw dashboard --no-open to recopy the current URL and auth details.",
      },
    },
  },
  chat: {
    ...
    catalogOpenTargetViewer: "HYClaw viewer",
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "Describe what HYClaw should do and when — it runs on schedule.",
    ...
    detail: {
      ...
      newSubtitle: "Describe what HYClaw should do, then pick when it runs.",
    ...
    form: {
      ...
      promptPlaceholder: "Describe what HYClaw should do...",
      repeat: "Repeat",
