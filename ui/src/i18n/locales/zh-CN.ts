...
export const zh_CN: TranslationMap = {
  ...
  lazyView: {
    ...
    staleTitle: "有新版本可用",
    staleSubtitle: "HYClaw 已在后台更新。请重新加载以获取最新面板。",
    retry: "重试",
  },
  nodes: {
    pairing: {
      ...
      review: "审核",
      waiting: "官方 HYClaw 移动应用在扫描后会自动连接。",
      help: "配对帮助",
      manageDevices: "管理设备",
    },
    binding: {
  ...
  worktrees: {
    ...
    title: "托管的 Worktrees",
    subtitle: "由 HYClaw 拥有的隔离代码库检出。",
    cleanNow: "立即清理",
    cleanupTitle: "清理",
    cleanupSubtitle: "HYClaw 会定期移除旧工作树以释放磁盘空间。可调整清理的执行强度。",
  ...
  configView: {
    ...
    retry: "重试",
    applyBannerText: "已保存到 hyclaw.json — 重启 Gateway 以应用更改。",
  ...
  modelSetup: {
    heading: "连接您的 AI",
    intro: "HYClaw 可复用您已有的 AI 访问方式——CLI 登录、API 密钥或提供商登录。",
    ...
    access: {
      ...
      gatewayTooOld: "此 Gateway 正在运行较旧版本的 HYClaw",
    },
    candidates: {
  ...
  memoryImport: {
    ...
    confirmBackup: "HYClaw 会在复制记忆前创建经过验证的导入前备份。",
    confirmImport: "导入记忆",
    disconnected: "请连接到 Gateway 以导入记忆。",
    title: "导入助手记忆",
    subtitle: "将 Codex 整合记忆和 Claude Code 自动记忆复制到 HYClaw 前，请先进行检查。",
    agent: "目标智能体",
  ...
  onboarding: {
    memoryImport: {
      title: "随身带上您的助手记忆",
      body: "HYClaw 发现了其他编程助手的记忆。要将其导入您的智能体工作区吗？",
      ...
      unknownError: "请求失败",
      doneTitle: "记忆导入完成",
      doneBody: "已迁移 {migrated} 项，已跳过 {skipped} 项。您可以继续设置 HYClaw。",
    },
  },
  mcpPage: {
  ...
  pluginsPage: {
    ...
    noInstalledBody: "发现精选插件或搜索 ClawHub，以扩展 HYClaw。",
    ...
    optionalCapability: "可选 HYClaw 功能。",
    enabled: "已启用",
    disabled: "已禁用",
    available: "可用",
    needsAttention: "需要注意",
  ...
  profilePage: {
    avatarUpload: "点击设置个性头像",
    avatarInvalid: "请选择 1 MB 以内的图片。",
    avatarNeedsConnection: "请先连接到 Gateway 再修改头像。",
  ...
  skillWorkshop: {
    ...
    selfLearning: {
      pitchTitle: "开启自学习",
      pitchBody:
        "HYClaw 会审查纠正内容和已完成的重要运行任务，然后为此面板起草技能提案。此过程会消耗额外的后台 token，草案将作为待处理提案显示。",
      enable: "启用自学习",
      enabling: "正在启用…",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "粘贴 HYClaw dashboard --no-open 提供的令牌，或输入已配置的密码。",
        stepGenerate:
          "如果未配置令牌，请在 Gateway 主机上运行 HYClaw doctor --generate-gateway-token。",
        stepConnect: "更新凭据后再次点击 Connect。",
      },
      authFailed: {
        title: "认证不匹配",
        summary: "提供的凭据被拒绝。最常见原因是令牌已过期，或令牌来自另一个 Gateway URL。",
        stepDashboard: "运行 HYClaw dashboard --no-open 并打开新的 URL，或粘贴其中的令牌。",
      ...
      pairing: {
        ...
        stepList: "在 Gateway 主机上运行 HYClaw devices list。",
        stepApproveId: "批准此请求：HYClaw devices approve {requestId}。",
      ...
      protocol: {
        ...
        stepDashboard:
          "使用 HYClaw dashboard 重新打开提供的 dashboard，确保 UI 和 Gateway 来自同一安装。",
        stepDevUi: "如果使用 pnpm ui:dev，请基于当前 checkout 重新构建或重启开发 UI。",
        stepRestart: "更新 HYClaw 后重启 Gateway，使其提供当前协议。",
      },
      network: {
        title: "无法连接",
        summary: "浏览器无法完成 Gateway 连接。重试凭据前请检查目标和传输方式。",
        stepGateway: "使用 HYClaw status 或 HYClaw gateway run 确认 Gateway 正在运行。",
        stepUrl: "检查 WebSocket URL；当 Gateway 位于 HTTPS/Tailscale Serve 后面时使用 wss://。",
        stepDashboard:
          "使用 HYClaw dashboard --no-open 重新打开 dashboard，以重新复制当前 URL 和认证详情。",
      },
    },
  },
  chat: {
  ...
  cron: {
    ...
    list: {
      ...
      emptyTitle: "暂无计划任务",
      emptyHint: "描述 HYClaw 应该在何时做什么——它会按计划运行。",
    ...
    detail: {
      tabsLabel: "自动化详细信息",
      newTitle: "新建计划任务",
      newSubtitle: "描述 HYClaw 应该做什么，然后选择运行时间。",
      back: "所有自动化",
      settingsTab: "设置",
      historyTitle: "运行历史",
      generalSection: "通用",
    ...
    form: {
      ...
      promptPlaceholder: "描述 HYClaw 应执行的操作……",
      repeat: "重复",
      repeatInterval: "间隔",
      repeatOnce: "一次",
      repeatOnExit: "退出时",
