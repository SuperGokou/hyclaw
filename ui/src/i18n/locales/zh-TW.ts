...
export const zh_TW: TranslationMap = {
  ...
  lazyView: {
    ...
    staleTitle: "有新版本可用",
    staleSubtitle: "HYClaw 已在背景更新。請重新載入以取得最新面板。",
    retry: "重試",
  },
  nodes: {
    pairing: {
      ...
      review: "審查",
      waiting: "官方 HYClaw 行動 App 會在掃描後自動連接。",
      help: "配對說明",
      manageDevices: "管理裝置",
    },
    binding: {
  ...
  worktrees: {
    ...
    subtitle: "由 HYClaw 擁有的隔離儲存庫簽出。",
    cleanNow: "立即清理",
    cleanupTitle: "清理",
    cleanupSubtitle: "HYClaw 會定期移除舊的工作樹以釋放磁碟空間。您可以調整清理作業的積極程度。",
  ...
  configView: {
    ...
    retry: "重試",
    applyBannerText: "已儲存至 hyclaw.json — 重新啟動 Gateway 以套用。",
  ...
  modelSetup: {
    heading: "連接您的 AI",
    intro: "HYClaw 會重複使用您已有的 AI 存取方式 — CLI 登入、API 金鑰或供應商登入。",
    ...
    access: {
      ...
      gatewayTooOld: "Gateway 正在執行較舊版本的 HYClaw",
    },
    candidates: {
  ...
  memoryImport: {
    ...
    confirmBackup: "HYClaw 會在複製記憶前建立並驗證匯入前備份。",
    confirmImport: "匯入記憶",
    disconnected: "請連線至 Gateway 以匯入記憶。",
    title: "匯入助理記憶",
    subtitle: "將 Codex 整合記憶和 Claude Code 自動記憶複製到 HYClaw 前，請先檢閱內容。",
    agent: "目標代理程式",
  ...
  onboarding: {
    memoryImport: {
      title: "隨身帶著您的助理記憶",
      body: "HYClaw 發現了其他程式設計助理的記憶。要將其匯入您的代理工作區嗎？",
      ...
      unknownError: "要求失敗",
      doneTitle: "記憶匯入完成",
      doneBody: "已移轉 {migrated} 項，已略過 {skipped} 項。您可以繼續設定 HYClaw。",
    },
  },
  mcpPage: {
  ...
  pluginsPage: {
    ...
    noInstalledBody: "探索精選外掛或搜尋 ClawHub，以擴充 HYClaw。",
    ...
    optionalCapability: "選用的 HYClaw 功能。",
    enabled: "已啟用",
    disabled: "已停用",
    available: "可用",
    needsAttention: "需要注意",
  ...
  aboutPage: {
    ...
    linkDiscord: "Discord",
    linkChangelog: "更新日誌",
    license: "© 2026 HYClaw Foundation — MIT 授權條款。",
  ...
  profilePage: {
    avatarUpload: "點擊設定個性頭像",
    avatarInvalid: "請選擇 1 MB 以內的圖片。",
    avatarNeedsConnection: "請先連線至 Gateway 再修改頭像。",
  ...
  skillWorkshop: {
    ...
    selfLearning: {
      pitchTitle: "開啟自我學習",
      pitchBody:
        "HYClaw 會檢視修正內容及已完成的重要執行結果，接著為此看板擬定技能提案。這會耗用額外的背景 token，而草稿會以待處理提案的形式送達。",
      enable: "啟用自我學習",
      enabling: "正在啟用…",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "貼上 HYClaw dashboard --no-open 提供的權杖，或輸入已設定的密碼。",
        stepGenerate:
          "如果尚未設定權杖，請在 Gateway 主機上執行 HYClaw doctor --generate-gateway-token。",
        stepConnect: "更新憑證後再次按一下 Connect。",
      },
      authFailed: {
        title: "驗證不相符",
        summary: "提供的憑證遭到拒絕。最常見原因是權杖過期，或權杖複製自另一個 Gateway URL。",
        stepDashboard: "執行 HYClaw dashboard --no-open 並開啟新的 URL，或貼上其中的權杖。",
      ...
      pairing: {
        ...
        stepList: "在 Gateway 主機上執行 HYClaw devices list。",
        stepApproveId: "核准此要求：HYClaw devices approve {requestId}。",
      ...
      protocol: {
        ...
        stepDashboard:
          "使用 HYClaw dashboard 重新開啟提供的 dashboard，確保 UI 和 Gateway 來自同一安裝。",
        stepDevUi: "如果使用 pnpm ui:dev，請依目前 checkout 重新建置或重新啟動開發 UI。",
        stepRestart: "更新 HYClaw 後重新啟動 Gateway，使其提供目前協定。",
      },
      network: {
        title: "無法連線",
        summary: "瀏覽器無法完成 Gateway 連線。重試憑證前請檢查目標與傳輸。",
        stepGateway: "使用 HYClaw status 或 HYClaw gateway run 確認 Gateway 正在執行。",
        stepUrl: "檢查 WebSocket URL；當 Gateway 位於 HTTPS/Tailscale Serve 後方時使用 wss://。",
        stepDashboard:
          "使用 HYClaw dashboard --no-open 重新開啟 dashboard，以重新複製目前 URL 與驗證詳細資料。",
      },
    },
  },
  chat: {
  ...
  cron: {
    ...
    list: {
      ...
      emptyTitle: "尚無排程工作",
      emptyHint: "描述 HYClaw 應該做什麼以及何時做 — 它會依排程執行。",
    ...
    detail: {
      tabsLabel: "自動化詳細資料",
      newTitle: "新排程任務",
      newSubtitle: "描述 HYClaw 應執行的內容，然後選擇執行時間。",
      back: "所有自動化",
      settingsTab: "設定",
      historyTitle: "執行歷史",
      generalSection: "一般",
    ...
    form: {
      ...
      promptPlaceholder: "描述 HYClaw 應執行的操作...",
      repeat: "重複",
      repeatInterval: "間隔",
      repeatOnce: "一次",
      repeatOnExit: "退出時",
