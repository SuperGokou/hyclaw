...
describe("renderAbout", () => {
  ...
  it("renders the hero with Clawd, identity, community links, and license", () => {
    ...
    expect(hero?.querySelector(".about-hero__name")?.textContent).toBe("HYClaw");
    ...
    expect(links.map((link) => link.getAttribute("href"))).toEqual([
      "https://github.com/SuperGokou/hyclaw",
      "https://github.com/SuperGokou/hyclaw/blob/main/README.md",
      "https://github.com/SuperGokou/hyclaw/releases",
    ]);
