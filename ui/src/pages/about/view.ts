...
// HYClaw points About links at the company's own repository instead of the
// upstream project's site/docs/community.
const ABOUT_LINKS: ReadonlyArray<{ href: string; icon: TemplateResult; label: () => string }> = [
  {
    href: "https://github.com/SuperGokou/hyclaw",
    icon: brandIcons.github,
    label: () => t("aboutPage.linkGitHub"),
  },
  {
    href: "https://github.com/SuperGokou/hyclaw/blob/main/README.md",
    icon: icons.book,
    label: () => t("aboutPage.linkDocs"),
  },
  {
    href: "https://github.com/SuperGokou/hyclaw/releases",
